...
public class test2 {
	public static void main(String args[]) throws Exception {
		/*
		 * DataSource source = new DataSource("arff200.arff"); Instances trainDataset =
		 * source.getDataSet();
		 * trainDataset.setClassIndex(trainDataset.numAttributes()-1);
		 * 
		 * LibSVM libSvm = new LibSVM(); libSvm.buildClassifier(trainDataset);
		 * System.out.println(libSvm);
		 * 
		 * DataSource source1 = new DataSource("arff200.arff"); Instances testDataset =
		 * source1.getDataSet();
		 ...
		 * value for the class double predSMO = libSvm.classifyInstance(newInst);
		 * 
		...
		System.out.println((float) dem/200);
